...
export const ALL_ADMIN_ENTITIES: Record<string, AdminEntityDef> = {
  ...
  packages: {
    ...
    fields: [
      ...
      { name: "moods", label: "Moods", type: "tags" },
      {
        ...
        listLabel: "Published",
        listToggle: true,
        listToggleOnLabel: "Published",
        listToggleOffLabel: "Draft",
        helpText: "When enabled, this package is live on the site (destination pages and linked itineraries).",
      },
      {
        ...
        type: "boolean",
        showInList: true,
        listLabel: "Hero slider",
        listToggle: true,
        listToggleOnLabel: "On slider",
        listToggleOffLabel: "Off slider",
        listHomepageVisibility: true,
        helpText: "When on, this package appears in the homepage hero slider (max set under Homepage hero slider).",
      },
      {
        name: "is_featured",
  ...
  itineraries: {
    ...
    fields: [
        ...
        readFrom: (r) => Array.isArray(r.gallery_media) ? r.gallery_media.map((m: {id:string}) => m.id) : [] },
      {
        ...
        listToggleOffLabel: "Off slider",
        listHomepageVisibility: true,
        helpText: "When on, this itinerary appears in the homepage hero slider (must be published).",
      },
      {
        name: "is_featured",
        label: "Homepage hero slider",
      ...
      { name: "seo_description", label: "SEO description", type: "textarea" },
      {
        ...
        listToggleOffLabel: "Draft",
        helpText:
          "When enabled, this itinerary is live on the public site. If linked to a package, publishing also publishes that package (and its other linked itineraries).",
      },
    ],
  },
  hotels: {
  ...
  media: {
    key: "media", label: "Media Asset", pluralLabel: "Media Assets", group: "catalog", endpoint: "/media", nameField: "slug", hideFromNav: true,
    fields: [
  ...
  faqs: {
    key: "faqs", label: "FAQ", pluralLabel: "FAQs", group: "content", endpoint: "/faqs", nameField: "question", hideFromNav: true,
    fields: [
  ...
  "homepage-region-panels": {
    key: "homepage-region-panels",
    label: "Homepage Region Panel",
    pluralLabel: "Homepage Region Panels",
    group: "marketing",
    endpoint: "/homepage-region-panels",
    nameField: "label",
    fields: [
      {
        name: "label",
        ...
        listLabel: "Panel",
        placeholder: "India",
        helpText: "Shown on the homepage tab pills and the overlay badge (e.g. India, International).",
      },
      {
        name: "title",
        label: "Headline",
        ...
        showInList: true,
        listLabel: "Headline",
        placeholder: "The soul of the subcontinent",
        helpText: "Large title over the panel image on the homepage.",
      },
      {
        name: "description",
        label: "Description",
        ...
        helpText: "Body text under the headline on the homepage card.",
      },
      {
        name: "stat_text",
        label: "Badge stat",
        ...
        showInList: true,
        listLabel: "Stat",
        placeholder: "22+ States",
        helpText: "Gold text beside the badge label (e.g. 22+ States, 60+ Countries).",
      },
      {
        name: "highlights",
        label: "Destination chips",
        type: "tags",
        placeholder: "Kashmir, Kerala, Goa, Rajasthan",
        helpText:
          "Comma-separated chips under the description. Add at least 2 or the site may fall back to defaults.",
      },
      {
        ...
        mediaUploadOnly: true,
        helpText:
          "Homepage card carousel. Upload several photos — first image is the lead slide. Order is preserved.",
        readFrom: (r) => {
          if (Array.isArray(r.gallery_media_ids) && r.gallery_media_ids.length) {
            return r.gallery_media_ids.map(String);
          }
          // Back-compat: older rows only had a single hero image.
          return r.hero_media_id ? [String(r.hero_media_id)] : [];
        },
      },
      {
        name: "hero_media_id",
      ...
      },
      {
        ...
        options: [
          ...
          { value: "India", label: "India (legacy key)" },
          { value: "domestic", label: "Domestic" },
          { value: "international", label: "International" },
          { value: "International", label: "International (legacy key)" },
        ],
        helpText: "Drives the default destinations filter link and India vs International styling. Prefer india / international.",
      },
      {
        name: "mood",
        label: "Visual mood",
        type: "select",
        options: [
          { value: "", label: "Auto from region key" },
          { value: "warm", label: "Warm — India / domestic" },
          { value: "cool", label: "Cool — International" },
        ],
        helpText: "Affects image treatment and which destination gallery set is used.",
      },
      {
        name: "href",
        label: "CTA link",
        type: "text",
        required: true,
        placeholder: "/destinations?region=domestic",
        helpText:
          'Button always reads “Explore {tab label}”. Use /destinations?region=domestic or /destinations?region=international.',
      },
      {
        name: "sort_order",
        label: "Sort order",
        ...
        required: true,
        showInList: true,
        helpText: "Lower numbers appear first in the homepage tabs.",
      },
      {
        name: "is_active",
        ...
        helpText: "When off, this panel is hidden from the homepage region section.",
      },
    ],
  },
