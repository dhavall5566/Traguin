...
export function PageCTA() {
  ...
  return (
    <section className="page-cta relative mt-16 overflow-hidden rounded-[1.75rem] border border-gold/20 px-6 py-10 sm:px-10 sm:py-12 md:mt-20 md:px-14">
      <div
      ...
      <div className="relative grid items-center gap-8 lg:grid-cols-[1fr_auto] lg:gap-10">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-sm leading-relaxed text-foreground/78 sm:text-base">{description}</p>
        </div>
