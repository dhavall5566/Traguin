...
export function Navigation() {
  ...
  return (
    <>
      <header
        className={cn(
          "pointer-events-none fixed top-0 right-0 left-0 z-50 transition-[padding] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]",
        ...
        >
          ...
          <div className="nav-bar-actions relative z-10 ml-auto flex shrink-0 items-center gap-2 md:gap-2.5">
            ...
            <button
              type="button"
              className={cn(
                "nav-menu-btn flex h-9 w-9 items-center justify-center rounded-full border transition-all duration-300 lg:hidden",
                mobileOpen
        ...
        {mobileOpen && (
          <>
            ...
            <motion.div
              ...
              className="nav-mobile-panel fixed inset-x-3 top-[4.75rem] z-40 flex max-h-[calc(100dvh-5.5rem)] flex-col overflow-hidden rounded-3xl border border-glass-border shadow-2xl lg:hidden"
